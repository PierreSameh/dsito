<x-filament::widget>
    <x-filament::card>
        ...
        @endphp
        <h2 class="text-lg font-bold text center" style="text-align: center; padding: 16px">Messages Between Customer and Delivery</h2>
        @if ($messages->count())
        ...
        @else
            <p class="text-gray-500" style="text-align: center;padding: 24px 0 0px;">No messages available.</p>
        @endif
    </x-filament::card>
